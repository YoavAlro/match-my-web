...
- Uses the user's OpenAI or Anthropic account, model, and API key.
...
- Voice transcription is OpenAI-only in the current MVP. Text requests work with OpenAI and Anthropic.
