...
Tweaksy does not operate a backend, create user accounts, run analytics, sell data, or send data to the developer.
...
The selected AI provider processes data under its own terms and privacy policy. Tweaksy does not control provider retention. Users should not submit sensitive pages unless their provider configuration and account policy are appropriate.
