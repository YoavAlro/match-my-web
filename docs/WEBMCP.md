...
| `preview_tweaksy_accessibility_mode` | Reversible write | Applies one of ten fixed accessibility previews through the normal adaptation controller, covering color vision, low vision, reading comfort, motion, focus, imagery, and keyboard access. |
